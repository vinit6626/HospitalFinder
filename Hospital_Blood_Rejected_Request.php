...
$result=$obj->myQuery("select * from order_blood where `status`= 2 and `hospital_id`= '".$_POST["hospital_id"]."' ");
...
//  print_r ($row);
    $return["STATUS"]="1";
    $return["Order_Details"]=$resultData;
}
else{
  $return["STATUS"]="0";
  $return["Order_Details"]="not avialbale";

}
}
else{
  $return["STATUS"]="00";
  $return["Order_Details"]="field is not set.. ";
