...
$obj=new Config();
if(isset($_POST["patient_id"]) && isset($_POST["hospital_id"]) && isset($_POST["medicine_id"]) && isset($_POST["quantity"]) &&
 isset($_POST["date"])  ){


   $insData["patient_id"]=$_POST["patient_id"];
   $insData["hospital_id"]=$_POST["hospital_id"];
   $insData["medicine_id"]=$_POST["medicine_id"];
   $insData["quantity"]=$_POST["quantity"];
   $insData["date"]=$_POST["date"];

   $result= $obj->insert("order_medicine",$insData);

   if($result){

     $insData1["patient_id"]=$_POST["patient_id"];
     $insData1["hospital_id"]=$_POST["hospital_id"];
     $result1= $obj->insert("notification_medicine",$insData1);
      if($result1){
