...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2019 at 05:14 PM
...
INSERT INTO `appointment` (`appointment_id`, `patient_id`, `hospital_id`, `docter_id`, `date`, `time`, `status`) VALUES
(3, 12, 31, 67, '2019-03-07', '8 pm', '0');
...
(67, 84, 31, 'Extrathings00@gmail.com', '03-03-2019-12-28-29.jpg', 'rajesh', 'amitabh', 'kapoor', 'mbbs', '1234567890', 'dental'),
(68, 85, 31, 'niravlimbani189@gmail.com', '03-03-2019-02-23-59.jpg', 'Nirav', 'Pravinbhai', 'Limbani', 'MS', '1234567890', 'orthodopedic');
...
(22, 41, 'abci', '07-01-2019-07-55-26profile.jpg', '07-01-2019-07-55-26.jpg', 'Ghevariya', 'rajesh', '123456789', 'Dental', 'Private', '12 hours', '12', 'rushal arcade', 'hirabag', 'varacha', '395002', 'Surat', 'Gujarat', '49.55', '45.8888', 'Gahshshsh', 'Ghjdjjh', '07-01-2019-07-55-26file.pdf', '1'),
...
(28, 57, 'anb@gmail.com', '10-01-2019-10-14-28profile.jpg', '10-01-2019-10-14-28.jpg', 'a', 'a', '123456789', 'Orthodopedic', 'Goverment', '24', 'a', 'a', 'a', 'a', '39500', 'Surat', 'Gujarat', '2', '44', 'Aja', 'Hhs', '10-01-2019-10-14-28file.pdf', '1'),
(31, 63, 'cvmadmissionprocess@gmail.com', '12-01-2019-12-07-17profile.jpg', '13-01-2019-11-18-17.jpg', 'Ghevariya', 'rajobhai', '1234567890', 'MultiSpecialist', 'Private', '12 hours', '12', 'rushal arcade', 'hirabag', 'varacha', '395002', 'Morbi', 'Gujarat', '39.75566', '45.98666', 'There is no emphasis on the core values.\nHI hello h r u.\nBye.\nHi\nAs\n1234567890 \n\n\nHsheusuujd.', 'Our hospital since 2000.\nShare joy.\n123\n\nOhk\nHI every two.\n\nFir.\n\n\nLion', '12-01-2019-12-07-17file.pdf', '1'),
(33, 69, 'xyza@gmail.com', '17-01-2019-10-23-19profile.jpg', '17-01-2019-10-23-19.jpg', 'kiran', 'kiran', '1234567890', 'Dental', 'Private', '24 hours', '1', 'royal', 'hirabag', 'varacha', '123456', 'Surat', 'Gujarat', '221.1911', '464949.44', 'Abc', 'Bca', '17-01-2019-10-23-19file.pdf', '1'),
...
(84, 'Extrathings00@gmail.com', '4ddeeddafe0cefb015b0d3d50b7c60c8', '2019-03-03', 'docter'),
(85, 'niravlimbani189@gmail.com', 'ca36d0262540fe9fe1a33263a6e0e519', '2019-03-03', 'docter');
...
INSERT INTO `medicine` (`medicine_id`, `hospital_id`, `name`, `stock`, `description`) VALUES
(1, 31, 'ASPIRINE', '20', '200gram clorin'),
(3, 31, 'DESPIRIN', '13', '300gram clorin, 100 gram salfied'),
(4, 31, 'TREX', '10', '100 clorine'),
(5, 31, 'TENPOSE', '20', '100 clorine'),
(6, 31, 'NEPRO', '10', '100 clorine'),
(7, 31, 'NEPRO1', '10', '100 clorine'),
(8, 31, 'NEPRO2', '15', '100 clorine'),
(9, 31, 'NEPRO3', '10', '100 clorine'),
(10, 31, 'NEPRO4', '10', '100 clorine'),
(11, 31, 'NEPRO5', '8', '100 clorine'),
(13, 31, 'ASPIRINE1', '10', '100 clorine'),
(14, 31, 'PERACITAMOAL', '10', '100 clorine'),
(15, 31, 'MEPTHELIN', '10', '100 clorine'),
(16, 31, 'ITHELIN', '20', '100 clorine'),
(17, 31, 'TREX11', '10', '100 gram carban'),
(18, 31, 'TONSEN', '20', 'It contain 100 gram clorin\n100 gram carban\n100 gram salfied\n100 gram ethen\n100 gram mithen\n100 gram akerelin\n100 gram toxicide');
...
--
ALTER TABLE `blood`
  MODIFY `blood_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `docter`
--
ALTER TABLE `docter`
  MODIFY `docter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `login`
  MODIFY `login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
